...
os.makedirs(                                                                    
    f"{DESTINATION_DIR.absolute().as_posix()}/producer_worker_logs/{platform.node()}/",  
    exist_ok=True,                                                              
)                                                                               
LOG_FILE = os.getenv(                                                           
    "LOG_FILE",                                                                 
    f"{DESTINATION_DIR.absolute().as_posix()}/producer_worker_logs/{platform.node()}/{platform.node()}.log",
)                                                                               
